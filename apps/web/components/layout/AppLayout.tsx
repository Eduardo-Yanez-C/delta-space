...
const titles: Record<string, { title: string; subtitle?: string }> = {
  ...
  "/empresas": { title: "Empresas", subtitle: "Multi-empresa: crear y administrar empresas (tenants)" },
  "/empresas/nueva": { title: "Nueva empresa", subtitle: "Crear empresa (tenant)" },
  "/instalaciones": { title: "Instalaciones", subtitle: "Equipos activados y revocación" },
  "/admin/auditoria": { title: "Auditoría", subtitle: "Registro de acciones y cambios críticos (solo admin)" },
  "/admin/invitaciones": { title: "Invitaciones", subtitle: "Invitar usuarios por link seguro (solo admin)" },
  "/admin/empresas/uso": { title: "Uso por empresa", subtitle: "KPIs por tenant (usuarios, cotizaciones, estudios, último login)" },
