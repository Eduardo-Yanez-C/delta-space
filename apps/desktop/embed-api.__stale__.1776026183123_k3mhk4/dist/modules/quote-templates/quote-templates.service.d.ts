...
export declare class QuoteTemplatesService {
    ...
    createTemplate(dto: CreateQuoteTemplateDto): Promise<{
        id: string;
        name: string;
        quoteKind: string;
        systemType: string;
    ...
    createQuoteFromTemplate(templateId: string, dto: CreateQuoteFromTemplateDto, currentUser: AuthUserPayload): Promise<{
        quote: Omit<{
            id: string;
            createdAt: Date;
            updatedAt: Date;
    ...
    updateTemplate(id: string, dto: UpdateQuoteTemplateDto): Promise<{
        id: string;
        name: string;
        quoteKind: string;
        systemType: string;
    ...
    updateTemplateItem(templateId: string, itemId: string, dto: UpdateTemplateItemDto): Promise<{
        id: string;
        name: string;
        quoteKind: string;
        systemType: string;
    ...
    createLine(templateId: string, itemId: string, dto: CreateTemplateLineDto): Promise<{
        id: string;
        createdAt: Date;
        updatedAt: Date;
        currency: string | null;
    ...
    updateLine(templateId: string, lineId: string, dto: UpdateTemplateLineDto): Promise<{
        id: string;
        createdAt: Date;
        updatedAt: Date;
        currency: string | null;
