...
exports.extractWpFromText = extractWpFromText;
exports.extractKwFromText = extractKwFromText;
exports.productMatchesConnectionType = productMatchesConnectionType;
exports.productMatchesMountingType = productMatchesMountingType;
exports.getCurrentPriceForProduct = getCurrentPriceForProduct;
exports.resolvePanelProductById = resolvePanelProductById;
exports.resolvePanelCandidate = resolvePanelCandidate;
exports.resolveInverterCandidate = resolveInverterCandidate;
exports.resolveStructureCandidate = resolveStructureCandidate;
function toNum(d) {
    if (d == null)
        return 0;
...
async function resolveCategoryId(tx, kind) {
...
function extractWpFromText(name, description) {
...
function extractKwFromText(name, description) {
    const text = [name, description].filter(Boolean).join(" ");
...
function productMatchesConnectionType(name, description, connectionType) {
...
function productMatchesMountingType(name, description, mountingType) {
    if (!mountingType)
        return false;
...
async function getCurrentPriceForProduct(tx, productId) {
    const now = new Date();
 ...
 */
async function resolvePanelProductById(tx, productId, quantity, _currency) {
...
async function resolvePanelCandidate(tx, study, _currency) {
...
async function resolveInverterCandidate(tx, study, _currency) {
...
async function resolveStructureCandidate(tx, study, _currency) {
